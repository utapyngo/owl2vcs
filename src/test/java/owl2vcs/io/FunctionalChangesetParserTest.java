...
public class FunctionalChangesetParserTest {
    ...
    @Test
    public void testChangeset() throws RecognitionException, UnknownOntologyFormatException, ParseException, OWLOntologyCreationException, IOException {
        String s =
        ...
        FunctionalChangesetParser parser = new FunctionalChangesetParser(s);
        parser.changeset();
    }
