...
public class ChangeSetTest {
    ...
    @Test
    public void testApplyTo() throws OWLOntologyCreationException,
            RecognitionException, UnknownOntologyFormatException,
            ParseException, IOException, UnsupportedOntologyFormatException {
        OWLOntology parent = OntologyUtils.loadOntology("parent.owl",
                ChangeSetTest.class);
        OWLOntology expected = OntologyUtils.loadOntology("child.owl",
                ChangeSetTest.class);
